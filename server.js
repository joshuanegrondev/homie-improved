//server.js - no longer api, stuff needed to set up server
//package.json - dependencies
//package-lock
//license - what they can do with this urlencoded
//gitignore -
//views - holds the ejs template
//config - files i DONT WANt anyone to see
//passport - authentication
//app: routes - api now; models - to create a new user
...
app.use(express.static('public')) //make routes from everything in the public directory
